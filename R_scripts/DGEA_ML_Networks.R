...
writeData(wb, "GO-BP", clustered_results[["GO-BP"]])
addWorksheet(wb, "GO-CC")
writeData(wb, "GO-CC", clustered_results[["GO-CC"]])
addWorksheet(wb, "GO-MF")
writeData(wb, "GO-MF", clustered_results[["GO-MF"]])
addWorksheet(wb, "KEGG")
writeData(wb, "KEGG", clustered_results[["KEGG"]])
addWorksheet(wb, "Reactome")
writeData(wb, "Reactome", clustered_results[["Reactome"]])
